...
| The Spriters Resource (MHXX) | https://www.spriters-resource.com/3ds/monsterhunterxx/ | The "Monster Icons" asset is an overlapping honeycomb collage poster, not a grid sprite sheet, so zero transparent gutters and you can't split it into individual icons. The site also 403s any scripted access (curl/requests). mhgu is already fully covered by monster-hunter-DB's clean transparent pixel icons anyway. |
...
style: natively small pixel art (24px tall, widths vary per sprite) with
near-black outlines and flat fills. No CAPCOM art is traced or embedded; the
designs reference the official monster appearances the same way any fan art
does. Same licensing posture as the rest of the repo: fan use, takedown on
request. See [pixelart/README.md](pixelart/README.md).
